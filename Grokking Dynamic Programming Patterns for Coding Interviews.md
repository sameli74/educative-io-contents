...
6. [Count of subset sum](https://www.geeksforgeeks.org/perfect-sum-problem-print-subsets-given-sum/)
7. [Target Sum (Leetcode)](https://leetcode.com/problems/target-sum/solution/)
